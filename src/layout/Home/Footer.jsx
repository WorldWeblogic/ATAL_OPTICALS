        ...
        <>
            ...
            <div className="bg-black text-white px-[5%] py-[1%] flex justify-between flex-wrap gap-y-8">
                ...
                <div>
                    ...
                    <ul className="space-y-1">
                        {[
                            ...
                            <li key={link}>
                                <a href="#" className="text-white hover:text-red-600 hover:underline text-lg">{link}</a>
                            </li>
                        ))}
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className="max-w-[200px] mt-1">
                        9980 Airport rd Unit #13 Brampton, Ont L6S 0J5. 905-497-2692
                    </p>
                </div>
            </div>

            <div className="bg-red-600 w-full h-[60px] flex justify-evenly items-center text-white text-lg">
                <div>
